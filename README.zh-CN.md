...
Claude Code 在生产代码里塞了 18 种虚拟宠物。Pi Mono 可以复用 Claude Code 的工具命名来实现兼容。MiroFish 的"集体智慧"本质是 LLM Agent 在模拟社交网络上互动协作。这些不是嘴炮——都是我们逐行读代码读出来的。
...
| 3 | **MiroFish 的"集体智慧" = LLM 社交模拟** —— 本质是 LLM Agent 在模拟社交网络上互动协作 | [MiroFish](mirofish/) | 5 万 Star 靠一个引人注目的 Agent 预测愿景驱动 |
...
| 005 | [**MiroFish**](mirofish/) | 50K | Python + Vue | 39K | LLM 社交模拟引擎实现集体智慧 | 已发布 |
