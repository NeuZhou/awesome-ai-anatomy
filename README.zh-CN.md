...
**我们读了 300 万行 AI Agent 源代码，这样你就不用读了。11 个项目，逐一解剖。有的藏了宠物系统，有的安全等于裸奔，所有项目都有 God Object。**
...
> 11 份 AI Agent 源代码深度分析——从编排框架到编程助手。
...
| 003 | [**DeerFlow**](deer-flow/) | 58K ⭐ | Python + TS | — | 14 层中间件、hash 循环 kill@5、无 RBAC | ✅ 已发布 |
| 004 | [**MiroFish**](mirofish/) | 50K ⭐ | Python + Vue | 39K | LLM 社交模拟冒充"集体智慧" | ✅ 已发布 |
| 005 | [**Goose**](goose/) | 37K ⭐ | Rust + TS | 198K | MCP-first 总线、5 级 Inspector Pipeline、30+ LLM | ✅ 已发布 |
| 006 | [**Pi Mono**](pi-mono/) | 32K ⭐ | TypeScript | 147K | 游戏引擎架构、伪装成 Claude Code 的隐身模式 | ✅ 已发布 |
| 007 | [**Lightpanda**](lightpanda-browser/) | 27K ⭐ | Zig + Rust | 91K | 为 AI Agent 从零造的浏览器、比 Chrome 快 9 倍 | ✅ 已发布 |
| 008 | [**Hermes Agent**](hermes-agent/) | 26K ⭐ | Python | 260K | 自进化 Skill、FTS5 搜索、冻结内存 | ✅ 已发布 |
| 009 | [**oh-my-claudecode**](oh-my-claudecode/) | 24K ⭐ | TypeScript | 194K | 19 个 Agent 通过文件 IPC 协作、Haiku→Opus 路由 | ✅ 已发布 |
| 010 | [**Guardrails AI**](guardrails-ai/) | 6.6K ⭐ | Python | 18K | Validator Hub、reask 自修正循环 | ✅ 已发布 |
| 011 | [**OpenAI Codex CLI**](codex-cli/) | 27K+ ⭐ | Rust | 549K | Queue-pair 架构、Guardian AI 审批、3 平台沙箱 | ✅ **新增** |
...
我们维护了一份详细的 **[COMPARISON.md](COMPARISON.md)**，对 11 个项目进行横向分析：
...
- [ ] Cursor — 争议最大的 AI IDE
- [ ] everything-claude-code (141K ⭐) — 优化 Harness
- [ ] agency-agents (72K ⭐) — Agent Swarm
...
每周更新一篇新 Teardown。我们正在逐个攻克最热门的 AI Agent 项目——Cursor、Windsurf 等等都在计划中。

**⭐ Star 这个仓库** → GitHub 会在新 Teardown 发布时通知你。Star 按钮本质上就是订阅按钮，不是虚荣指标。

**👁️ Watch** → 每篇新 Teardown 都会收到通知，不只是上了热门的那几篇。

我们已经发布了 11 篇深度拆解，覆盖 300 万行源代码。下一批已经在路上了。
...
<p align="center">
  <i>读了 300 万行代码。拆了 11 个项目。每周更新。<br>如果你在做 AI Agent，你应该知道最好的那些到底是怎么造的。</i>
</p>
